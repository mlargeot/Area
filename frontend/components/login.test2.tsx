...
const OAuthProviders = {
    google: {
        clientId: '388588349871-q74b1h4i7ojhn5ki7hn7l2293lhuf1cd.apps.googleusercontent.com',
...
const REDIRECT_URI = AuthSession.makeRedirectUri({ scheme: 'comma-mobile',
    native: 'comma-mobile://'
});
...
export default function Login() {
    ...
    const [, response, prompt] = AuthSession.useAuthRequest({
        ...
        {
            authorizationEndpoint: OAuthProviders.google.authorizationEndpoint,
            tokenEndpoint: OAuthProviders.google.tokenEndpoint,
        });
